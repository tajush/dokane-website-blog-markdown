    ...
    >
      ...
      <div className="lg:grid grid-rows-1 lg:max-w-7xl m-auto px-4">
        <div className="grid grid-cols-12 justify-center items-center">
          <div className="relative lg:col-span-8 col-span-12 lg:font-bold font-semibold w-5/6">
            <h5
              itemProp="name"
            ...
            <p
              ...
              className="font-inter lg:text-base text-sm mt-4 max-w-[500px] font-thin"
            >
              {t("paymentSubTitle")}
            </p>
            <button
          ...
          <div className="lg:col-span-4 col-span-12">
            <figure className="relative z-10">
              <img
                ...
                src="/images/homepage/payment-img.png"
                width="471"
                height="436"
                alt="payment img"
              />
